...
var XPMobileSDK = new (function () {
  ...
  function connectWithId(server, connectionId, serverId) {
    XPMobileSDK.library.Connection.connectWithId(
      server,
      connectionId,
      serverId,
    );
  ...
  function Login(params, successCallback, failCallback) {
    ...
    if (XPMobileSDK.library.Connection.PublicKey) {
      params.Username = XPMobileSDK.library.Connection.dh.encodeString(
        params.Username,
      );
      params.Password = XPMobileSDK.library.Connection.dh.encodeString(
        params.Password,
      );
    }
    ...
    params.SupportsExtendedResamplingFactor =
      params.SupportsExtendedResamplingFactor || "Yes";
  ...
  function requestCode(successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.requestCode(
      successCallback,
      errorCallback,
    );
  }
  ...
  function LiveMessage(params, successCallback, failCallback) {
    XPMobileSDK.library.Connection.LiveMessage(
      params,
      successCallback,
      failCallback,
    );
  ...
  function getAllCameras(successCallback, errorCallback) {
    var connectionRequest = XPMobileSDK.library.Connection.getAllCameras(
      successCallback,
      errorCallback,
    );
    return connectionRequest || XPMobileSDK.interfaces.ConnectionRequest;
  ...
  function getViews(viewId, successCallback, errorCallback) {
    var connectionRequest = XPMobileSDK.library.Connection.getViews(
      viewId,
      successCallback,
      errorCallback,
    );
  ...
  function requestPushStream(successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.requestPushStream(
      successCallback,
      errorCallback,
    );
  }
  ...
  function CloseStream(params, successCallback, failCallback) {
    XPMobileSDK.library.Connection.CloseStream(
      params,
      successCallback,
      failCallback,
    );
   ...
   * @return {ConnectionRequest} - the ConnectionRequest object
   */
  function createVideoPushConnection(
    successCallback,
    errorCallback,
    skipUserMedia,
  ) {
   ...
   * @return {ConnectionRequest} - the ConnectionRequest object
   */
  function createAudioPushConnection(
    itemIds,
    sampleRate,
    successCallback,
    errorCallback,
  ) {
    var audioPushConnection = new XPMobileSDK.library.AudioPushConnection(
      itemIds,
      sampleRate,
      successCallback,
      errorCallback,
  ...
  function motionDetection(videoConnection, options) {
    return XPMobileSDK.library.Connection.motionDetection(
      videoConnection,
      options,
    );
  }
  ...
  function getPtzPresets(cameraId, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getPtzPresets(
      cameraId,
      successCallback,
      errorCallback,
    );
  ...
  function ptzPreset(videoConnection, presetName) {
    return XPMobileSDK.library.Connection.ptzPreset(
      videoConnection,
      presetName,
    );
  }
  ...
  function ptzTapAndHold(parameters, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.ptzTapAndHold(
      parameters,
      successCallback,
      errorCallback,
    );
  ...
  function playbackSeek(videoConnection, seekType) {
    return XPMobileSDK.library.Connection.playbackSeek(
      videoConnection,
      seekType,
    );
  }
  ...
  function getThumbnail(cameraId, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getThumbnail(
      cameraId,
      successCallback,
      errorCallback,
    );
  ...
  function getDBStartTime(cameraId, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getDBStartTime(
      cameraId,
      successCallback,
      errorCallback,
    );
   ...
   * @return {ConnectionRequest} - the ConnectionRequest object
   */
  function getSequencesInInterval(
    cameraId,
    startTime,
    endTime,
    investigationId,
  ...
  function getSequencesForView(
    ...
    return XPMobileSDK.library.Connection.getSequencesForView(
      cameraId,
      startTime,
      endTime,
      minTimeBetweenSequences,
  ...
  function getUserExports(successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getUserExports(
      successCallback,
      errorCallback,
    );
  }
  ...
  function getAllExports(successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getAllExports(
      successCallback,
      errorCallback,
    );
  }
  ...
  function getExport(id, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getExport(
      id,
      successCallback,
      errorCallback,
    );
   ...
   * @return {ConnectionRequest} - the ConnectionRequest object
   */
  function createExportDownloadLink(
    exportId,
    investigationId,
    exportType,
    successCallback,
    ...
    return XPMobileSDK.library.Connection.createExportDownloadLink(
      exportId,
      investigationId,
      exportType,
      successCallback,
  ...
  function getOutputsAndEvents(successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getOutputsAndEvents(
      successCallback,
      errorCallback,
    );
  }
  ...
  function getServerStatus(successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getServerStatus(
      successCallback,
      errorCallback,
    );
  }
  ...
  function getInvestigation(id, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getInvestigation(
      id,
      successCallback,
      errorCallback,
    );
   ...
   * @return {ConnectionRequest} - the ConnectionRequest object
   */
  function startInvestigationExport(
    investigationId,
    exportType,
    includeAudio,
    password,
   ...
   * @return {ConnectionRequest} - the ConnectionRequest object
   */
  function deleteInvestigationExport(
    investigationId,
    exportType,
    successCallback,
    errorCallback,
  ...
  function getAlarmList(parameters, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getAlarmList(
      parameters,
      successCallback,
      errorCallback,
    );
  ...
  function getAlarm(alarmId, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getAlarm(
      alarmId,
      successCallback,
      errorCallback,
    );
  ...
  function updateAlarm(parameters, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.updateAlarm(
      parameters,
      successCallback,
      errorCallback,
    );
  ...
  function getAlarmUsers(alarmId, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getAlarmUsers(
      alarmId,
      successCallback,
      errorCallback,
    );
  ...
  function acknowledgeAlarm(alarmId, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.acknowledgeAlarm(
      alarmId,
      successCallback,
      errorCallback,
    );
  ...
  function getBookmarks(parameters, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.getBookmarks(
      parameters,
      successCallback,
      errorCallback,
    );
  ...
  function deleteBookmark(id, successCallback, errorCallback) {
    return XPMobileSDK.library.Connection.deleteBookmark(
      id,
      successCallback,
      errorCallback,
    );
  ...
  function CreateBookmark(params, successCallback, errorCallback) {
    XPMobileSDK.library.Connection.CreateBookmark(
      params,
      successCallback,
      errorCallback,
    );
  ...
  function UpdateBookmark(params, successCallback, errorCallback) {
    XPMobileSDK.library.Connection.UpdateBookmark(
      params,
      successCallback,
      errorCallback,
    );
  ...
  function RequestBookmarkCreation(params, successCallback, errorCallback) {
    XPMobileSDK.library.Connection.RequestBookmarkCreation(
      params,
      successCallback,
      errorCallback,
    );
