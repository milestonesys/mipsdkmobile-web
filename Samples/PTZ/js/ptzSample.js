(function (undefined) {
  var PtzController = function () {
    ...
    function attachPtzControlBar() {
      var ptzTemplate = document.getElementsByClassName(
      ...
      ptzControl
        .querySelector(".ptz-up")
        .addEventListener("click", ptzCommands.up);
      ptzControl
        .querySelector(".ptz-right")
        .addEventListener("click", ptzCommands.right);
      ptzControl
        .querySelector(".ptz-down")
        .addEventListener("click", ptzCommands.down);
      ptzControl
        .querySelector(".ptz-left")
        .addEventListener("click", ptzCommands.left);
      ptzControl
        .querySelector(".ptz-upRight")
        .addEventListener("click", ptzCommands.upRight);
      ptzControl
        .querySelector(".ptz-upLeft")
        .addEventListener("click", ptzCommands.upLeft);
      ptzControl
        .querySelector(".ptz-downRight")
        .addEventListener("click", ptzCommands.downRight);
      ptzControl
        .querySelector(".ptz-downLeft")
        .addEventListener("click", ptzCommands.downLeft);
      ptzControl
        .querySelector(".ptz-home")
        .addEventListener("click", ptzCommands.home);
      ptzControl
        .querySelector(".ptz-zoomIn")
        .addEventListener("click", ptzCommands.zoomIn);
      ptzControl
        .querySelector(".ptz-zoomOut")
        .addEventListener("click", ptzCommands.zoomOut);
    }

    function applyPtzPreset(event) {
      event.stopPropagation();

      XPMobileSDK.ptzPreset(
        self.videoConnection,
    ...
    function displayPtzPresets(presets) {
      ...
      presetsElement.innerHTML =
        document.querySelector(".tmpl_ptzPresets").innerHTML;
    ...
    function requestPtzPresets() {
      ...
      XPMobileSDK.getPtzPresets(
        self.videoConnection.cameraId,
        displayPtzPresets,
      );
    }
