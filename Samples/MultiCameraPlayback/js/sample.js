...
(function (undefined) {
  ...
  function Controller() {
    ...
    function onPlaybackEvents(playbackEvents) {
      if (
        playbackEvents &
        XPMobileSDK.library.ItemHeaderParser.PlaybackFlags.Stopped
      ) {
        // onPlaybackStopped();
      }
      if (
        playbackEvents &
        XPMobileSDK.library.ItemHeaderParser.PlaybackFlags.Forward
      ) {
        // onPlaybackForward();
      }
      if (
        playbackEvents &
        XPMobileSDK.library.ItemHeaderParser.PlaybackFlags.Backward
      ) {
        // onPlaybackBackwards();
      }
    }
    ...
    function updateTime(timestamp) {
      ...
      document.querySelector(".topbar .playTimeIndex").innerHTML =
        formattedTime;
    }
