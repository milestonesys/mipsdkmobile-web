...
class VideoStream {
  constructor(videoId, connectionRequest, callbacks) {
    ...
    this.videoConnectionElement.location =
      XPMobileSDKSettings.MobileServerURL + XPMobileSDKSettings.videoChanel;
    this.videoConnectionElement.addEventListener(
      "onReceivedFrame",
      this.onReceivedFrame.bind(this),
    );
    this.videoConnectionElement.addEventListener(
      "onConnectionError",
    ...
    this.isDirectStreaming =
      this.request.parameters.StreamType == "FragmentedMP4";
    ...
    this.callbacks.onClose =
      this.callbacks.onClose || function (videoConnection) {};
    this.callbacks.onRestart =
      this.callbacks.onRestart || function (videoConnection) {};
