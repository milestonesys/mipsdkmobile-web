(function (undefined) {
  var videoParser = function (data) {
    ...
    function parseHeader() {
      ...
      self.hasSizeInformation =
        MainHeader & XPMobileSDK.library.ItemHeaderParser.HeaderExtensionSize;
      self.hasLiveInformation =
        MainHeader &
        XPMobileSDK.library.ItemHeaderParser.HeaderExtensionLiveEvents;
      self.hasPlaybackInformation =
        MainHeader &
        XPMobileSDK.library.ItemHeaderParser.HeaderExtensionPlaybackEvents;
      self.hasNativeData =
        MainHeader & XPMobileSDK.library.ItemHeaderParser.HeaderExtensionNative;
      self.hasMotionInformation =
        MainHeader &
        XPMobileSDK.library.ItemHeaderParser.HeaderExtensionMotionEvents;
      self.hasLocationData =
        MainHeader &
        XPMobileSDK.library.ItemHeaderParser.HeaderExtensionLocationInfo;
      self.hasStreamInfo =
        MainHeader &
        XPMobileSDK.library.ItemHeaderParser.HeaderExtensionStreamInfo;
      self.hasCarouselInfo =
        MainHeader &
        XPMobileSDK.library.ItemHeaderParser.HeaderExtensionCarouselInfo;
      self.hasPlaybackInfo =
        MainHeader &
        XPMobileSDK.library.ItemHeaderParser.HeaderExtensionPlaybackInfo;
