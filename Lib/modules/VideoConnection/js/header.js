...
export default class VideoFrame {
  ...
  parseHeader() {
    ...
    this.hasLiveInformation =
      MainHeader & FrameHeaders.HeaderExtensionLiveEvents;
    this.hasPlaybackInformation =
      MainHeader & FrameHeaders.HeaderExtensionPlaybackEvents;
    this.hasNativeData = MainHeader & FrameHeaders.HeaderExtensionNative;
    this.hasMotionInformation =
      MainHeader & FrameHeaders.HeaderExtensionMotionEvents;
    this.hasLocationData =
      MainHeader & FrameHeaders.HeaderExtensionLocationInfo;
    this.hasStreamInfo = MainHeader & FrameHeaders.HeaderExtensionStreamInfo;
    this.hasCarouselInfo =
      MainHeader & FrameHeaders.HeaderExtensionCarouselInfo;
    this.hasPlaybackInfo =
      MainHeader & FrameHeaders.HeaderExtensionPlaybackInfo;
  ...
  parseSizeInformation() {
    ...
    this.sizeInfo.sourceCrop.width =
      this.sizeInfo.sourceCrop.right - this.sizeInfo.sourceCrop.left;
    this.sizeInfo.sourceCrop.height =
      this.sizeInfo.sourceCrop.bottom - this.sizeInfo.sourceCrop.top;
  ...
  parseStreamInfo() {
    ...
    this.stream.hasKeyFrame =
      (this.stream.flags & FrameHeaders.StreamInfoFlags.HasKeyFrame) ===
      FrameHeaders.StreamInfoFlags.HasKeyFrame;
  }
